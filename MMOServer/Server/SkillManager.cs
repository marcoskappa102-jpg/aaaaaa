...
/// <summary>
        /// ✅ CORRIGIDO - Valida se o personagem pode aprender a skill
        /// </summary>
        ...
        /// <summary>
        /// ✅ CORRIGIDO - Learn skill com validação de null
        /// </summary>
        ...
        /// <summary>
        /// ✅ CORRIGIDO - Level up skill com validação de null
        /// </summary>
        public bool LevelUpSkill(Player player, int skillId)
        {
            // ✅ CORREÇÃO - Valida se lista existe
            if (player.character.learnedSkills == null)
            {
                Console.WriteLine($"❌ Player has no learned skills");
                return false;
            }
